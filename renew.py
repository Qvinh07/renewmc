...
login_data = {
    "username": "quangvinh17099", # đổi thành username acc mcserver vào đây
    "email": "", # hoặc dùng mail để mail thì thôi username 
    "password": {
        "value": "28200712", # password điền vào 
        "repeat": ""
    }
}
sub_url = "https://www.mcserverhost.com/api/servers/527258f3/subscription" # dán vào đây 
def run_automation():
